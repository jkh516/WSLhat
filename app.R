...
team.colours <- c("Arsenal" = "red" , "Aston Villa" = "maroon" , "Birmingham" ="yellow", "Brighton" = "gold", "Bristol City" = "green" , "Chelsea" = "blue", "Everton" = "brown" , 
...
team.colours2223 <- c("Arsenal"="red", "Aston Villa" = "maroon" ,  "Brighton" = "gold",    "Chelsea" = "blue",  "Everton" = "brown", "Leicester City" = "orange" , "Liverpool" = "darkgreen", "Manchester City" = "skyblue", "Manchester United" = "black", "Tottenham" = "darkblue", "West Ham"="grey", "Reading" = "purple" )
team.colours2122 <- c("Arsenal"="red", "Aston Villa" = "maroon" , "Birmingham" ="yellow", "Brighton" = "gold",    "Chelsea" = "blue",  "Everton" = "brown", "Leicester City" = "orange" , "Liverpool" = "darkgreen", "Manchester City" = "skyblue", "Manchester United" = "black", "Tottenham" = "darkblue", "West Ham"="grey" )
...
team.colours1819 <- c("Arsenal"="red", "Birmingham" ="yellow", "Brighton" = "gold",  "Bristol City" = "green" ,  "Chelsea" = "blue",  "Everton" = "brown", "Liverpool" = "darkgreen", "Manchester City" = "skyblue"  ,"Reading" = "purple", "West Ham"="grey" , "Yeovil" = "pink"  )
team.colours1718 <- c("Arsenal"="red", "Birmingham" ="yellow",   "Bristol City" = "green" ,  "Chelsea" = "blue",  "Everton" = "brown", "Liverpool" = "darkgreen", "Manchester City" = "skyblue"  ,"Reading" = "purple", "Sunderland" = "cyan"  , "Yeovil" = "pink"  )
team.colours17 <- c("Arsenal"="red", "Birmingham" ="yellow",   "Bristol City" = "green" ,  "Chelsea" = "blue", "Liverpool" = "darkgreen", "Manchester City" = "skyblue"  ,"Reading" = "purple", "Sunderland" = "cyan"  , "Yeovil" = "pink"  )
